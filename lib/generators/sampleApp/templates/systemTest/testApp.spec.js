...
describe('Test SampleApp build', () => {

  let pages = require('./pages');
  let page1 = pages.page1();
  let page2 = pages.page2();

  it('should have two pages which show one image, a font icon, links, a heading and the CSS preprocessor type', () => {
    page1.get();
    ...
    expect(page1.logo.getAttribute('width')).toEqual('454');
    expect(page1.logo.getAttribute('height')).toEqual('406');
