...
/**
 *
 * @returns {Object|{description: string, name: string}}    Package JSON object
 * @this generator
 */
 ...
 *
 * @param {Object[]} packages   A package has a name and a version. If the name contains a '/',
...
function setNpmDependencies(deps, isAddDep, optKey) {
  ...
  let addDep = isAddDep === undefined ? true : !!isAddDep;
