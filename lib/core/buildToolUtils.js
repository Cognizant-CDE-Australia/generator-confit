...
function writeCommonConfig(commonResourceData, optionalTemplateData, copyTemplateFn) {
  ...
  // The resource data may also have a configModules array, which we want to automatically process
  let resourceDataArray = [commonResourceData].concat(commonResourceData.configModules || []);
