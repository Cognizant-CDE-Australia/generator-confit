...
/**
 * Adds readme badges to the readme document.
 *
 * @param {Array} badgeArray      Array of badge information (name, imageUrl, url)
 * @this generator
 */
function addReadmeBadges(badgeArray) {
  (badgeArray || []).forEach((badge) => addReadmeDoc.call(this, `badges.${badge.name}`, badge));
}
